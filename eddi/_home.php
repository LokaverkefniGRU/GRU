        ...
        <form class="well col-lg-12" action="" method="POST">
            ...
            <?php 
                    ...
                    if (is_object($result) && $result->num_rows > 0) {
                        ...
                        $sql .= " ORDER BY post.date_time DESC";
                            ...
                            while($row = $result->fetch_assoc()) {
                                for ($i=0; $i < count($log); $i++) { 
                                    ...
                                    echo("<div class='well col-lg-12 col-md-12 col-sm-12'><hr>
                                                ...
                                                <div class='date'><small> <a class='smalltext' style='float: right' href='post.php?post=" . $row['id'] . "'>" . $row['date_time'] . " </a></small></div>
                                                <img class='profilepic' style='height: 40px; width: 40px' src='" . $row['image'] . "'</img> <h2 style=' font-size: 15px;'><a href='profile.php?id=" . $row['user_ID'] . "'>" . $row['fullname'] . "</a></h2>
                                                <div class='postcontent'><h4>" . $row['title'] . "</h4>" . $row['content'] . "</div><hr>
                                                <button class='likebutton'><i class='fa fa-heart-o'></i></button><span class='likecounter'>" . $row['likes'] . "</span> 
